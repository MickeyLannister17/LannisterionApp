...
def notifications(request):
    ...
    if goto != '':
        ...
        if notification.notification_type == Notification.MESSAGE:
            ...
            return redirect('lannisterianprofile', username=notification.created_by.username)
        elif notification.notification_type == Notification.LIKE:
            return redirect('lannisterianprofile', username=notification.to_user.username)
